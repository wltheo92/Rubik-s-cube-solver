...
class Cube:
    ...
    def do_moves(self, moves: Union[str, List[Move]]):
        ...
        # Pass it on to the appropriate functions (either cube rotation or face rotation)
        for move in moves:
            if move.face == "y":
                self._y_rotate()
            else:
    ...
    # Rotates the adjacent faces to face, around the ccube
